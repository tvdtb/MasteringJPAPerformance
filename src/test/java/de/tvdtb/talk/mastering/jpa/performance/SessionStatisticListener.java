...
public class SessionStatisticListener extends BaseSessionEventListener {
	...
	public int getJdbcConnectionAcquisitionCount() {
		return jdbcConnectionAcquisitionCount;
	}

	public long getJdbcConnectionAcquisitionTime() {
		return jdbcConnectionAcquisitionTime;
	}

	public int getJdbcConnectionReleaseCount() {
		return jdbcConnectionReleaseCount;
	}

	public long getJdbcConnectionReleaseTime() {
		return jdbcConnectionReleaseTime;
	}

	public int getJdbcPrepareStatementCount() {
		return jdbcPrepareStatementCount;
	}
	...
	public int getJdbcExecuteStatementCount() {
		return jdbcExecuteStatementCount;
	}
	...
	public int getJdbcExecuteBatchCount() {
		return jdbcExecuteBatchCount;
	}
	...
	public long getFlushEntityCount() {
		return flushEntityCount;
	}

	public long getFlushCollectionCount() {
		return flushCollectionCount;
	}
	...
	public int getPartialFlushCount() {
		return partialFlushCount;
	}

	public long getPartialFlushEntityCount() {
		return partialFlushEntityCount;
	}

	public long getPartialFlushCollectionCount() {
		return partialFlushCollectionCount;
	}

	public long getPartialFlushTime() {
		return partialFlushTime;
	}

	public long getJdbcBatchExecutionStart() {
		return jdbcBatchExecutionStart;
	}
